      ...
      <div className="auth-sheet" style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', background: '#1a2236', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 8, overflow: 'hidden' }}>
              ...
              <input value={phone} onChange={e => setPhone(e.target.value.replace(/\D/g, '').slice(0, 9))} placeholder="712 345 678" type="tel" inputMode="numeric" autoComplete="tel"
                style={{ border: 'none', background: 'transparent', borderRadius: 0, flex: 1, color: '#f1f5f9', WebkitTextFillColor: '#f1f5f9', fontSize: 16 }} />
            </div>
          </div>
