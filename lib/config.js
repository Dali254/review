...
// so a single edit updates the homepage, business pages, wallet, and
// admin dashboard consistently.

// ── Earnings per review, by star rating ──
// What a reviewer earns when they give 1–5 stars. Shown on the homepage
// earnings table, the business detail page, and used to calculate payouts.
...
export const PUBLISH_FEE_KES = 15;
...
export const WITHDRAWAL_TAX_RATE = 0.16;
...
export const PRO_PRICE_KES = 299;

// ── Withdrawal minimum ──
// Smallest amount (in KES, before tax) a user can withdraw at once.
export const MIN_WITHDRAWAL_KES = 1000;
